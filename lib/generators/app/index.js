...
function Generator() {
  ...
  this.argument('name', {
    type: String,
    desc: "Hey whats your project called?",
    required: true
  });
...
Generator.prototype.askFor = function askFor() {
  ...
  var prompts = [
    ...
    },
    {
      type: 'confirm',
      name: 'coreJs',
      message: 'Include DN core js?'
    }
  ];

  this.prompt(prompts, function(props) {
    this.coreCss = props.coreCss;
    this.coreJs = props.coreJs;
    this.staticDir = props.staticDir;
    cb();
  }.bind(this));
};
...
Generator.prototype.projectFiles = function projectFiles() {
  ...
  this.template('application/app/app.js', this.staticDir + '/scripts/app.js');
  this.template('application/app/app.js', this.staticDir + '/scripts/main.js');
